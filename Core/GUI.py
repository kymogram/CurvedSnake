...
class GUI:
    ...
    def menuStart(self):
        ...
        # colorVal.trace('w', lambda n, m, s: self.backgroundComboBox())
    ...
    def backgroundComboBox(self):
        color = self.color.getColor()
        self.color.colors_menu.configure(bg=color, fg=color,
